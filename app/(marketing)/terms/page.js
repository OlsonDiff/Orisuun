export const metadata = {
  ...
  title: 'Orisuun | Terms And Conditions',
  description:
...
export default function Terms() {
  return (
    <main id="main" className="mb-[109px]">
      <section>
        <div className="text-center">
          <h1 className="text-7xl small-500:text-3xl font-bold text-black">
            Terms and Conditions
          </h1>
        </div>
      </section>
      <section className="sm:py-4 revealed">
        <div className="md:container sm:mx-auto px-4 md:px-16">
          <div>
            <div className=" prose prose-lg max-w-none">
              ...
              <ul>
                ...
                <li>
                  <p>
                    ...
                    Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                    &quot;Our&quot; in this Agreement) refers to AU Constant
                    (D/B/A Orisuun), 8 The Green Ste. A, Dover DE 19901.
                  </p>
                </li>
                <li>
                  <p>
                ...
                <li>
                  <p>
                    <strong>Products</strong> refer to the items offered for
                    sale on the Service.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    ...
                    access to the Service offered on a subscription basis by the
                    Company to You.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to Orisuun, accessible from{' '}
                    <a
                      href="https://www.orisuun.com"
                      rel="external nofollow noopener"
                      target="_blank"
                    >
                      https://www.orisuun.com
                    </a>
                  </p>
                </li>
                <li>
              ...
              <p>
                Any Products you purchase can only be returned in accordance
              ...
              <h3>Payments</h3>
              <p>
                All Products purchased are subject to a one-time payment.
              ...
              <p>
                ...
                recurring and periodic basis (such as monthly, quarterly, or
              ...
              <p>
                ...
                dmca@orisuun.com and include in Your notice a detailed
              ...
              <p>
                ...
                dmca@orisuun.com. Upon receipt of a notification, the Company
              ...
              <p>
                ...
                such content, Products or services available on or through any
              ...
              <ul>
                <li>
                  By email:{' '}
                  <a href="mailto:info@orisuun.com">info@orisuun.com</a>
                </li>
              </ul>
            </div>
          </div>
