...
// Importing components and icons (assumed to exist)
...
// Importing images (assumed to exist)
import bgImage from '@/public/images/space.png';
import logo from '@/public/images/vector/logo.svg';
...
const profiles = [
  { icon: Community, label: 'Black Owned Businesses', value: "1" },
  { icon: Crown, label: 'Experts', value: "2" },
  { icon: Consultant, label: 'Consultants', value: "3" },
  { icon: Briefcase, label: 'Professionals', value: "4" },
  { icon: Gossip, label: 'Mentors', value: "5" },
  { icon: Dollars, label: 'Investors', value: "6" },
];
...
const ProfileSearch = () => {
  ...
  //       profile.toLowerCase().includes(text.toLowerCase())
  //     );
  //     setProfileSuggestions(filteredProfiles);
  //   }, 300);

  //   if (profileText) {
  //     debouncedSearch(profileText);
  //   } else {
  ...
  const handleSearch = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    router.push(`/profile-search/search-results?${searchParams.toString()}`);
  };
    ...
    <div className="relative min-h-screen">
      ...
      <div className="w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 p-4">
        <Image
          ...
          quality={100}
          priority
          className="mx-auto mb-3 w-64 h-20 2xl:w-scaled-32 2xl:h-scaled-10 text-white"
        />
        <h5 className="text-h5 2xl:text-scaled-h5 font-semibold text-white mb-10 mx-auto text-center">
