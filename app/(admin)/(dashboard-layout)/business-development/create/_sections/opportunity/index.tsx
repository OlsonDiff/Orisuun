...
const OpportunityDetails: React.FC<IProps> = ({ step, setStep, BdId, setBdId, loading }) => {
  ...
  console.log("watchedStrategy ", watchedTactics, watchedtags, watchedStrategy, errors, watchedStrategy);
